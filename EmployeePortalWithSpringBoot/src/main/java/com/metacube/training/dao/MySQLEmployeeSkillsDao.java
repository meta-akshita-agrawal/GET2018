...
public class MySQLEmployeeSkillsDao implements EmployeeSkillsDao{
	...
	private static final String INSERT_QUERY="insert into employeeportal.employee_skills(employee_code,skill_code) values(?,?) ";
	private static final String GET_SKILL_BY_EMPLOYEE_ID_QUERY = "select skill_code from employeeportal.employee_skills where employee_code=?";
	...
	public boolean insert(EmployeeSkills entity) {
		return jdbcTemplate.update(INSERT_QUERY, entity.getEmployeeID(), entity.getSkillID()) > 0;
	}
